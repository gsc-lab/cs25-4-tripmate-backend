...
class ScheduleItemsService extends Service{
  ...
  public function __construct(
    ...
    parent::__construct($db);
        $this->scheduleItemsRepository = $scheduleItemsRepository ?? new ScheduleItemsRepository($db);
  ...
  public function createScheduleItem(
    ...
    ?string $memo
      ...
      try {
        // 1-1. 트래잭션 시작
        return $this->transaction(function(PDO $pdo) use ($userId, $tripId, $dayNo, $placeId, $visitTime, $memo) {
  ...
  public function updateScheduleItem(
    ...
    ?string $memo
      ...
      try {
        return $this->transaction(function(PDO $pdo) use ($userId, $tripId, $itemId, $dayNo, $visitTime, $memo) {
  ...
  public function deleteScheduleItem(
    ...
    try {
      return $this->transaction(function(PDO $pdo) use ($userId, $tripId, $dayNo, $itemId) {
...
public function reorderSingleScheduleItem(
  ...
  int $newSeqNo
    ...
    try {
      return $this->transaction(function(PDO $pdo) use ($userId, $tripId, $dayNo, $scheduleItemId, $newSeqNo) {
